    ...
    <>
      ...
      >
        ...
        <div className="relative z-50">
          <p className="bg-slate-50 shadow-[0_3px_10px_-12px_rgba(0,0,0,0.3)] Geist-bold text-[8px] sm:text-[9px] lg:text-[13px] w-[140px] sm:w-[160px] lg:w-[220px] uppercase text-blue-950 mx-auto p-1 pb-0.5 sm:pb-1 lg:pb-1 lg:p-1.5 rounded-full">
            Get Twisted with Twist
          </p>
          ...
          <p className="nunito-medium mt-5 w-[90vw] sm:w-[80vw] lg:w-[680px] mx-auto text-[#021734] text-[12px] lg:text-[16px] lg:leading-[26px]">
            Twist Technologies is a premier software firm crafting high-caliber
